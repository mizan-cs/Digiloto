                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @if(Auth::user()->is_agent)
                                            <a class="dropdown-item" href="{{route('organizer.dashboard')}}">Agent Dashboard</a>
                                    @endif
    ...
    <ul class="side-menu-list">
        ...
        <li class="aquamarine">
            <a href="">
                ...
                <span class="lbl">My Operator</span>
            </a>
        </li>
...
<div class="page-content">
    <div class="container-fluid">
        ...
        @endif
        @if (\Auth::user()->agent->active == false)
            <div class="alert alert-warning text-center" role="alert">
                Your agent is not active. Contact with your operator to activate.
            </div>
        @endif
    </div>
    @yield('content')
